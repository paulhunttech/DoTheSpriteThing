...
namespace DoTheSpriteThing.Tests
{
    public class SpriteManagerTests
    {
        ...
        private Mock<IMagickImageHelper> _magickImageHelper;
        ...
        public void CreateSprite_ImageFileDoesNotExist_ShouldUseDefaultPlaceholder()
        {
            ...
            var placeholderImageByteArray = Convert.FromBase64String(Image272X100Base64);
        ...
        public void CreateSprite_ImageFileDoesNotExist_ShouldUseSelectedPlaceholder()
        {
            ...
            var placeholderImageByteArray1 = Convert.FromBase64String(Image272X100Base64);
            var placeholderImageByteArray2 = Convert.FromBase64String(Image100X56Base64);
        ...
        public void CreateSprite_NullSpriteSettingsParam_ShouldThrow()
        {
            ...
            exception.ParamName.ShouldBe("spriteSettings");
        }
        ...
        public void CreateSprite_ValidFileListInImagesParam_ShouldGenerateCss()
        {
            ...
            var image2Colour = MagickColor.FromRgb(2, 2, 2);
        ...
        public void CreateSprite_ValidMixedFileAndByteArrayListInImagesParam_ShouldGenerateSprite()
        {
            ...
            var imageFile1 = new FileInfo(@"C:\a.png");
            var imageByteArray2 = Convert.FromBase64String(Image272X100Base64);
            ...
            spriteImages[0].Width.ShouldBe(image1Width);
            spriteImages[0].Height.ShouldBe(image1Height);
            spriteImages[1].Width.ShouldBe(Image252X175Width);
            spriteImages[1].Height.ShouldBe(Image252X175Height);
        }
    }
}